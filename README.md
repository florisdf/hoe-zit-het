...
bestanden die instaan voor de *inhoud* ([`content`](/content)) en de *weergave* 
([`layouts`](/layouts)). Hieronder een overzicht van de directories:
...
De lessen worden geschreven in markdown-bestanden in de [`content/lessen`](/content/lessen) 
directory. Eender welk `index.md`-bestand in 
`content/lessen/<vak>/<lesblok>/<les>/`, zal omgezet worden naar de HTML-pagina 
van een les.

Het bestand [`content/lessen/wiskunde/functies/domein_beeld/index.md`](/content/lessen/wiskunde/functies/domein_beeld/index.md), 
