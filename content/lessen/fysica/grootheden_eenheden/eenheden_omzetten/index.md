...
Met de voorgaande 3 gelijkheden, kunnen we alle omzettingen tussen dagen, uren,
...
Het enige wat je van buiten moet kennen zijn de bovenstaande 3 gelijkheden.
...
| ------------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------- | -----------                                                                                                      |
| $\si{d}$      | $\si{h}$       | /                                                                                                                                    | $1 \si{ d} = 24 \si{ h}$        | \begin{split}7{,}00 \orange{\si{ d}} &= 7{,}00 \cdot \orange{24 \si{ h}}\\\\\ &= 168 \orange{\si{ h}}\end{split}           |
| $\si{d}$      | $\si{min}$     | \begin{split}1 \si{ d} &= 24 \orange{\si{ h}}\\\\\ &= 24 \cdot \orange{60\si{ min}}\\\\\ &= 1440 \orange{\si{ min}}\end{split}       | $1 \si{ d} = 1440 \si{ min}$    | \begin{split}7{,}00 \orange{\si{ d}} &= 7{,}00 \cdot \orange{1440 \si{ min}}\\\\\ &= 10{,}1\cdot 10^{3} \orange{\si{ min}}\end{split} |
| $\si{d}$      | $\si{s}$       | \begin{split}1 \si{ d} &= 1440 \orange{\si{ min}}\\\\\ &= 1440 \cdot \orange{60\si{ s}}\\\\\ &= 86\ 400 \orange{\si{ s}}\end{split}  | $1 \si{ d} = 86\ 400 \si{ s}$   | \begin{split}7{,}00 \orange{\si{ d}} &= 7{,}00 \cdot \orange{86\ 400 \si{ s}}\\\\\ &= 605 \cdot 10^3 \orange{\si{ s}}\end{split} |

### Van uur naar...
| Van           | Naar           | Afleiding                                                                                                                                                                                                                                                                         | Kort gezegd                          | Voorbeeld                                                                                                                                                        |
|---------------|----------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| $\si{h}$      | $\si{d}$       | \begin{split}1 \si{ d} &= 24 \si{ h}\\\\\ &\Updownarrow\\\\\  \frac{1 \si{ d}}{\orange{24}} &= \frac{24 \si{ h}}{\orange{24}}\\\\\ &\Updownarrow\\\\\  \frac{1}{\orange{24}} \si{ d} &= 1 \si{ h} \\\\\ &\Updownarrow\\\\\  1 \si{ h} &= \frac{1}{\orange{24}} \si{ d}\end{split} | $1 \si{ h} = \frac{1}{24} \si{ d}$   | \begin{split}8{,}00 \orange{\si{ h}} &= 8{,}00 \cdot \orange{\frac{1}{24} \si{ d}}\\\\\ &= \frac{8{,}00}{24} \orange{\si{ d}}\\\\\ &= 0{,}333 \orange{\si{ d}} \end{split} |
...
| $\si{min}$   | $\si{d}$   | \begin{split}1 \si{ min} &= \frac{1}{60}\orange{\si{ h}} \\\\\ &=\frac{1}{60}\cdot \orange{\frac{1}{24}\si{ d}}\\\\\ &=\frac{1}{\orange{1440}}\si{ d} \end{split}                                                                                                                           | $1 \si{ min} = \frac{1}{1440} \si{ d}$   | \begin{split}90{,}0 \orange{\si{ min}} &= 90{,}0 \cdot \orange{\frac{1}{1440} \si{ d}}\\\\\ &= \frac{90{,}0}{1440} \orange{\si{ d}}\\\\\ &= 0{,}0625 \orange{\si{ d}} \end{split}   |
...
| $\si{s}$   | $\si{d}$   | \begin{split}1 \si{ s} &= \frac{1}{3600}\orange{\si{ h}} \\\\\ &=\frac{1}{3600}\cdot \orange{\frac{1}{24}\si{ d}}\\\\\ &=\frac{1}{\orange{86\ 400}}\si{ d} \end{split}                                                                                                                      | $1 \si{ s} = \frac{1}{86\ 400} \si{ d}$  | \begin{split}30{,}0 \orange{\si{ s}} &= 30{,}0 \cdot \orange{\frac{1}{86\ 400} \si{ d}}\\\\\ &= \frac{30{,}0}{86\ 400} \orange{\si{ d}}\\\\\ &= 3{,}47\cdot 10^{-4} \orange{\si{ d}} \end{split} |
